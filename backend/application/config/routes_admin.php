...
$route['admin/surcharges']                     = 'admin/surcharges';
$route['admin/surcharges/new']                 = 'admin/surcharge_new';
$route['admin/surcharges/(:num)']              = 'admin/surcharge_edit/$1';
...
$route['admin/api/surcharges']                 = 'admin_api/surcharges_index';
$route['admin/api/surcharges/save']            = 'admin_api/surcharges_create';
$route['admin/api/surcharges/(:num)/save']     = 'admin_api/surcharges_update/$1';
$route['admin/api/surcharges/(:num)/delete']   = 'admin_api/surcharges_delete/$1';
$route['admin/api/surcharges/(:num)/toggle']   = 'admin_api/surcharges_toggle/$1';
